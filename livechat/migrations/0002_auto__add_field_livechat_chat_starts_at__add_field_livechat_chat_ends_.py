...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LiveChat.chat_starts_at'
        db.add_column('livechat_livechat', 'chat_starts_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 9, 12, 0, 0)),
                      keep_default=False)

        # Adding field 'LiveChat.chat_ends_at'
        db.add_column('livechat_livechat', 'chat_ends_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 9, 12, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LiveChat.chat_starts_at'
        db.delete_column('livechat_livechat', 'chat_starts_at')

        # Deleting field 'LiveChat.chat_ends_at'
        db.delete_column('livechat_livechat', 'chat_ends_at')
    ...
    models = {
        ...
        'livechat.livechat': {
            ...
            'chat_ends_at': ('django.db.models.fields.DateTimeField', [], {}),
            'chat_starts_at': ('django.db.models.fields.DateTimeField', [], {}),
